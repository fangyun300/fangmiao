<template>
	    <div id="detailContrainer" class="slide-enter-active">
	        <HeaderBar title="影片详情"><i class="iconfont icon-fanhui" @touchstart="handleToBack"></i></HeaderBar>
	        ...
	        <div v-else id="content" class="contentDetail">
	        	...
	        	<div class="detail_player swiper-container" ref="detail_player">
	        		<ul class="swiper-wrapper">
	        			<li class="swiper-slide" v-for="(item, index) in photos">
	        				<div>
	        					<img :src="item | setWH('120.208')" alt="">
	        				</div>
	        			</li>
	        		</ul>
	        	</div>
...
#content.contentDetail{ display: block; margin-bottom:0; margin-top: 40px;}
